...
void registerUser() {
    ...
    for (User user : users) {
        if (user.login == login) {
            ...
            registerUser(); // Просим повторный ввод, если логин уже существует
            return;
        }
    }
...
User* loginUser() {
    ...
    cout << "Пользователь не найден. Пожалуйста, зарегистрируйтесь." << endl;
    return nullptr;
}
...
void addPlayer() {
    ...
    do {
        ...
        if (invalidInput) {
            cout << "Ошибка: имя игрока должно содержать только буквы. Попробуйте снова." << endl;
        }
    } while (invalidInput);
    ...
    do {
        ...
        if (invalidInput) {
            cout << "Ошибка: фамилия игрока должна содержать только буквы. Попробуйте снова." << endl;
        }
    } while (invalidInput);
    ...
    do {
        ...
        if (invalidInput) {
            cout << "Ошибка: позиция игрока должна содержать только буквы. Попробуйте снова." << endl;
        }
    } while (invalidInput);
    ...
    do {
        ...
        if (cin.fail()) {
            ...
            invalidInput = true;
            cout << "Ошибка: количество голов забитых игроком должно быть целым числом. Попробуйте снова." << endl;
        }
    } while (invalidInput);
    ...
    do {
        ...
        if (cin.fail()) {
            ...
            while (std::cin.get() != '\n'); // Читаем символы до символа новой строки
            invalidInput = true;
            cout << "Ошибка: количество штрафных минут игрока должно быть целым числом. Попробуйте снова." << endl;
        }
    } while (invalidInput);
...
int main() {
    ...
    while (isRunning) {
        ...
        int option;
        while (!(cin >> option)) {
            cout << "Неверный ввод. Пожалуйста, введите цифру еще раз:" << endl;
            cin.clear();
            cin.ignore(10000, '\n');
        }
        while (option < 1 || option > 3) {
            cout << "Неверный выбор. Пожалуйста, выберите опцию еще раз:" << endl;
            cin.clear();
            cin.ignore(10000, '\n');
            while (!(cin >> option)) {
                cout << "Неверный ввод. Пожалуйста, введите цифру еще раз:" << endl;
